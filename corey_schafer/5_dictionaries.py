...
'''
A dictionary is a collection which is unordered, mutable and indexed. In Python dictionaries are written 
with {}, and they have keys and values. 
...
student.update({'name':'Jane','age':28, 'sex':'female'})    # updates and/or adds elements to the dictionary in-place
...
for key, value in student.items():      # This is called dictionary unpacking. See tuple unpacking.
    print(key, value)
